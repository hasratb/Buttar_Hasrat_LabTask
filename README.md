...
Additionally, when asked whether they would want an optional way to save certain payments as private memory cards with notes/photos/context, 89% of the participants in the user survey said yes. Based on this, we created **Wallet Memories** which allows for users to save transfers and the corresponding card attachments to the archive. This is where users will be able to go back and visit transfers and the memories attached to them. The transfer will act similar to a momento. This would also allow easy access to memories as typically a lot of particular moments are scattered across various apps in our phones.

Overall, Apple Wallet Moments focuses on enhancing connection and memory preservation in an app that can otherwise feel very cold and inexpressive.
